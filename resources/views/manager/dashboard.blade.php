...
<div class="container mx-auto px-4">
    ...
    <div id="default-styled-tab-content" class="bg-white shadow-lg rounded-3xl my-4 opacity-75 mx-auto flex items-center" style="width: 91.666667%;">
        ...
        <div class="bg-white p-6 opacity-75 rounded-3xl my-4 mx-auto hidden w-full" id="styled-dashboard" role="tabpanel" aria-labelledby="dashboard-tab" style="min-height: 30em;">
