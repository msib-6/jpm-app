        ...
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white opacity-75 p-6 rounded-3xl shadow-2xl my-4 mx-auto flex items-center justify-between"
                ...
                <div class="flex justify-end">
                    <button id="exportPDF"
                        class="bg-purple-500 text-white px-4 py-2 rounded-lg hover:bg-purple-600 mr-2">Export to
                        PDF</button>
                    <button id="exportCSV" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 mr-2">Export
                        to CSV</button>
            ...
            <div class="header-days bg-white opacity-75 p-6 rounded-3xl shadow-2xl my-4 mx-auto" style="width:100%;"
                ...
                <div class="grid grid-cols-11 gap-4 text-center font-semibold">
                    <div class="flex-1 flex-col font-bold text-center justify-center text-lg mt-2">Mesin</div>
                    <div class="flex-1 flex-col font-bold items-center justify-center text-lg mt-2">Kategori</div>
                    <div class="flex-1 flex-col font-bold items-center justify-center text-lg mt-2">Tahun</div>
                    <div class="flex-1 flex-col font-bold items-center justify-center text-lg mt-2">Bulan</div>
                    ...
                    <div class="flex-1 flex-col font-bold items-center justify-center text-lg mt-2">Status</div>
                    <div class="flex-1 flex-col font-bold items-center justify-center text-lg mt-2">Notes</div>
            ...
            async function fetchMachineOperations() {
                try {
                    ...
                    operations.forEach(operation => {
                        ...
                        let monthIndex = operation.month - 1; // Array index (0-11)
                        let year = operation.year;

                        // Adjust month if day <= 5 and day >= 1 and week == 5
                        if (day >= 1 && day <= 5 && operation.week == 5) {
                            monthIndex += 1;
                            if (monthIndex > 11) {
                        ...
                        const values = [
                            operation.machine_name, operation.category, year, month, operation.week,
