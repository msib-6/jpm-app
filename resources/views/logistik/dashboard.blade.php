...
<div class="container mx-auto px-4">
    ...
    <div class="bg-white opacity-75 p-6 rounded-3xl shadow-2xl my-4 mx-auto flex items-center justify-between" style="width: 100%;">
        ...
        <button id="exportPDF" class="bg-purple-500 text-white px-4 py-2 rounded-lg hover:bg-purple-600">Export to PDF</button>
    </div>
...
<script>
        ...
        try {
            ...
            audits.forEach(audit => {
                if (audit.event === 'edit') {
                    ...
                    const month = ["Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"][parseInt(newState.month) - 1];
    ...
    function filterData() {
        ...
        rows.forEach(row => {
            ...
            if ((lineFilter !== 'all' && line !== lineFilter) || (statusFilter !== 'all' && status !== statusFilter)) {
