...
<div class="container mx-auto px-4">
    ...
    <div id="returnNotesModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-lg">
            <h2 class="text-2xl mb-4">Return Notes</h2>
            <textarea id="returnNotesInput" class="w-full p-2 border rounded" rows="4" placeholder="Enter return notes here..."></textarea>
            <div class="flex justify-between items-center mt-4">
                <button type="button" id="closeReturnNotesModalButton" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 mr-2">Cancel</button>
                <button type="button" id="submitReturnNotesButton" class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const returnNotesModal = document.getElementById('returnNotesModal');
        const closeReturnNotesModalButton = document.getElementById('closeReturnNotesModalButton');
        const submitReturnNotesButton = document.getElementById('submitReturnNotesButton');
        const returnNotesInput = document.getElementById('returnNotesInput');
        ...
        function showReturnNotesModal() {
            returnNotesModal.classList.remove('hidden');
        }
        ...
        returnButton.onclick = async () => {
            showActionConfirmation('Return Confirmation', 'Are you sure you want to return this week?', showReturnNotesModal);
        };
        ...
        submitReturnNotesButton.onclick = async () => {
            ...
            if (returnNotes === '') {
                showAlert('Please enter return notes before submitting.');
                return;
            }
