...
<head>
    ...
    <script src="{{ asset('flatpickr') }}"></script>
    ...
    <nav class="flex ml-16 mt-3" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li class="inline-flex items-center">
                <a href="/pjl/{{ ucfirst($line)}}/pmdashboard" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
...
<script>
    ...
    // content.innerHTML = `<p class="text-sm font-bold">Mesin: ${op.machine_name}</p>
    //                              <p class="text-sm">
    //                                 <span class="font-bold">Tanggal:</span>
    //                                 <span>${formattedDate}</span>
    //                             </p>`;
